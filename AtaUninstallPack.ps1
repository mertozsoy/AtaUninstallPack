...
.DESCRIPTION Creates Intune detection and remediation scripts for application uninstallation.
...
function New-AppInfoJson {
    ...
    $safeName = Convert-ToSafeName $App.ApplicationName
    $policyName = "Aves_Remove$safeName"
...
function New-Package {
    ...
    foreach ($app in $Apps) {
        try {
            $safeName = Convert-ToSafeName $app.ApplicationName
            $targetFolder = Join-Path -Path $ParentFolder -ChildPath "Remove$safeName"
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Intune Remediation Package Generator"
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#F9F9F9" BorderBrush="#C0C7D4" BorderThickness="0,0,0,1">
            <Grid Margin="32,0">
                ...
                <StackPanel Grid.Column="0" Orientation="Horizontal" VerticalAlignment="Center">
                    <Border Width="32" Height="32" CornerRadius="8" Background="#005FAA" HorizontalAlignment="Center" VerticalAlignment="Center">
                        <TextBlock Text="pkg" FontSize="14" FontWeight="700" Foreground="White" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                    </Border>
                    <TextBlock Margin="12,0,0,0" Text="Intune Remediation Package Generator" FontSize="20" FontWeight="600" VerticalAlignment="Center" Foreground="#1A1C1C"/>
                </StackPanel>
        ...
        <Border Grid.Row="2" Background="#EEEEEE" BorderBrush="#C0C7D4" BorderThickness="0,1,0,0" Padding="32,0">
            <Grid>
                ...
                <StackPanel Grid.Column="0" Orientation="Horizontal" VerticalAlignment="Center">
                    <TextBlock FontSize="12" FontWeight="700" Foreground="#1A1C1C" VerticalAlignment="Center" Margin="0,0,0,1">Total Applications:</TextBlock>
                    <TextBlock x:Name="StatusTotal" Margin="4,0,0,0" FontSize="12" Foreground="#404752" VerticalAlignment="Center">0</TextBlock>
                    <Border Width="1" Height="12" Background="#C0C7D4" Margin="16,0"/>
                    <TextBlock FontSize="12" FontWeight="700" Foreground="#005FAA" VerticalAlignment="Center" Margin="0,0,0,1">Selected:</TextBlock>
                    <TextBlock x:Name="StatusSelected" Margin="4,0,0,0" FontSize="12" Foreground="#005FAA" VerticalAlignment="Center">0</TextBlock>
                </StackPanel>
                <StackPanel Grid.Column="1" HorizontalAlignment="Right" Orientation="Horizontal" VerticalAlignment="Center">
                    <Border Width="8" Height="8" CornerRadius="4" Background="#10B981" VerticalAlignment="Center"/>
                    <TextBlock Margin="8,0,0,0" FontSize="12" Foreground="#404752" VerticalAlignment="Center">Status: <Run FontWeight="700">Ready for Generation</Run></TextBlock>
                </StackPanel>
            </Grid>
        </Border>
    </Grid>
...
$statusTotal = $window.FindName("StatusTotal")
$statusSelected = $window.FindName("StatusSelected")
...
function Update-Grid {
    ...
    $statusTotal.Text = "$($script:allApps.Count)"
...
function Update-DetailsPanel {
    ...
    if ($app) {
        ...
        $safeName = Convert-ToSafeName $app.ApplicationName
        $detailPolicyName.Text = "Remove$safeName"
    } else {
